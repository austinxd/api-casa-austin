    ...
    try {
        ...
        if (name === "get_active_today") {
            ...
            const mapRes = (r) => ({
                ...
                phone: r.phone,
                precio_sol: r.price_sol,
                precio_usd: r.price_usd,
                anticipo: r.advance_payment,
                moneda_anticipo: r.advance_payment_currency,
                pagado_completo: r.full_payment,
                extra_late_checkout_sol: r.price_latecheckout,
                extra_piscina_temperada_sol: r.price_temperature_pool,
                puntos_canjeados: r.points_redeemed,
