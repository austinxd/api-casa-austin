...
from .views import (
    ...
    CurrentReferralRankingView, ClientReferralStatsView, PublicReferralStatsView, AllReferrersView
)
...
urlpatterns = [
    ...
    path('clients/all-referrers/', AllReferrersView.as_view(), name='all-referrers'),
