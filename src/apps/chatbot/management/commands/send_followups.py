...
FOLLOWUP_QUOTED_PROMPT = (
    ...
    "1. CHECK-IN AMABLE → 'Hola 😊 ¿Pudiste revisar la opción?'\n"
    "2. RECORDAR LA COTIZACIÓN → 'Te dejo a la mano la cotización por si la estás "
    "revisando con tu grupo.'\n"
    "3. INVITACIÓN A SEPARAR (sin presión):\n"
    "   'Si te interesa, te paso el link para separarla con el 50%.'\n"
    "   'Como la fecha está cerca, si aún te interesa, lo mejor es separarla con el 50%.'\n"
    "4. OCASIÓN ESPECIAL → Referencia la ocasión: 'Para tu [cumpleaños/evento], la opción que "
    "vimos calza perfecto. Si te interesa, te paso el link para separarla con el 50%.'\n\n"
    "Reglas:\n"
    "- Máximo 3-4 líneas\n"
