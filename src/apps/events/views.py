...
class IngresosAnalysisView(APIView):
    ...
    def _generate_analysis(self, django_settings, date, timedelta, Reservation,
        ...
        user_message = (
            ...
            "IMPORTANTE: Muestra el cálculo paso a paso para cada casa, ejemplo: "
            "'Casa X: 5 noches sem × S/280 + 2 noches fds × S/450 = S/2,300'. "
            "Indica escenario conservador (50-60% ocupación) y optimista (90-100%), mostrando cómo se aplica el porcentaje. "
            ...
            "IMPORTANTE: Para cada mes proyectado, muestra brevemente la lógica: "
            "'Mar 2026: Mar 2025 fue S/X, crecimiento YoY promedio es Z%, ajuste estacional → S/W'. "
            "Sé crítico: si solo tienes pocos meses de datos del año actual, reconoce la incertidumbre. "
        ...
        # --- Llamar a OpenAI (gpt-4.1-mini: balance entre calidad y velocidad) ---
        MODEL = "gpt-4.1-mini"
