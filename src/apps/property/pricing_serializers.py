...
class PropertyPricingSerializer(serializers.Serializer):
    ...
    extra_person_price_usd = serializers.DecimalField(max_digits=10, decimal_places=2)
    extra_person_price_sol = serializers.DecimalField(max_digits=10, decimal_places=2)
